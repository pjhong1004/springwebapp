...
public class Ch04Form3Validator implements Validator{@Override
	...
	public void validate(Object target, Errors errors) {
		...
		//param1 검사
		String param1 = ch04Form3.getParam1();
		if(param1 == null || param1.equals("")) {
			errors.rejectValue("param1", "errors.form3.required", "필수 입력(D)");
		} else if(param1.length() < 8) {
			errors.rejectValue("param1", "errors.form3.minlength", new Object[] {8}, "최소 8자 입력(D)");
		} else if(param1.length() > 15) {
			errors.rejectValue("param1", "errors.form3.maxlength", new Object[] {8}, "최대 15자 입력(D)");
		}
		
		//param2 검사
		String param2 = ch04Form3.getParam2();
		if(param2 == null || param2.equals("")) {
			errors.rejectValue("param2", "errors.form3.required", "필수 입력(D)");
		} else {
			String regExp = "^(010|011)-[0-9]{3,4}-[0-9]{4}$";
			boolean result = Pattern.matches(regExp, param2);
			if(result ==false) {
			errors.rejectValue("param2", "errors.form3.format", "형식에 맞지 않음(D)");
		}
	}
		//param3 검사
		String param3 = ch04Form3.getParam3();
		if(param3 == null || param3.equals("")) {
			errors.rejectValue("param3", "errors.form3.required", "필수 입력(D)");
		} else {
