...
public class Ch04Form4Validator implements Validator{@Override
	...
	public void validate(Object target, Errors errors) {
		...
		if(param1 == null || param1.equals("")) {
			...
			errors.rejectValue("param1", "errors.form1.maxlength", new Object[] {8}, "최대 15자 입력(D)");
		}
		...
		if(param2 == null || param2.equals("")) {
			...
			if(result ==false) {
			errors.rejectValue("param2", "errors.form1.format", "형식에 맞지 않음(D)");
		}
	}
		//param3 검사
		...
		if(param3 == null || param3.equals("")) {
			...
			if(result ==false) {
				errors.rejectValue("param3", "errors.form1.format", "형식에 맞지 않음(D)");
			}
		}		
	}	
}
