   	...
   	<div class="card m-2">
         ...
         <script>
            function checkData() {
               ...
               //입력 길이 체크
               let param1 = form.param1.value; //document.querySelector("#form1 [name=param1]")value;
         ...
         <div class="card-body">
            <form id="form2" name="form2" action="method2">
               ...
               <div class="input-group">
                  ...
                  <div class="btn-group btn-group-toggle" data-toggle="buttons">
                     <label class="btn btn-secondary active">
                       <input type="radio" name="param4"<c:if test="${ch04Form2.param4}">checked</c:if> value="true"> true
                     </label>
                     <label class="btn btn-secondary">
                       <input type="radio" name="param4"<c:if test="${!ch04Form2.param4}">checked</c:if> value="false"> false
                     </label>
                  </div>
               </div>
               <div class="input-group">
                  <div class="input-group-prepend"><span class="input-group-text">param5</span></div>
                  <input type="date" name="param5" class="form-control" value='<fmt:formatDate value="${ch04Form2.param5}" pattern="yyyy-MM-dd"/>'/>
               </div>
	           <div class="mt-2">
